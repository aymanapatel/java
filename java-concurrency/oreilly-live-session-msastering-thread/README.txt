...
The course material for our Mastering Threads Course on XXXXXXXXXX
is available from a private git repository:

  URL: https://www.javaspecialists.eu/git/XXXXXX/masteringthreads-XXXX.git
  Username: XXXXXX
  Password: XXXXXX
...
3. Clone the repository:
   ...
   3.3. You can also clone from the command line by downloading git from
        ...
        Then issue this command in a terminal or command prompt:
          ...
          git clone https://www.javaspecialists.eu/git/XXXXXX/masteringthreads-XXXX.git
          Username: XXXXXX
          Password: XXXXXX
